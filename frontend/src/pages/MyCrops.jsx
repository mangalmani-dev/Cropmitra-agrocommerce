...
const MyCrops = () => {
  ...
  const { crops, fetchFarmerCrops, deleteCrop, loading } = useCropStore();
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          {crops.map((crop) => (
            ...
            >
              ...
              {/* Delete Button */}
              <button
                className="w-full mt-3 bg-red-500 hover:bg-red-600 text-white py-1.5 rounded-lg text-sm transition"
